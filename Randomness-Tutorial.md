...
- **Custom Feeds**: Create your own feeds in [Custom Feeds](/custom-feeds/build-and-deploy-feed.md)
...
```
GET https://docs.switchboard.xyz/docs-by-chain/solana-svm/randomness/randomness-tutorial.md?ask=<question>
```
